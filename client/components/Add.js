        ...
        if(this.state.messageFromServer == "") {
            return (
                <div>
                    ...
                    contentLabel="Add Expense" className="Modal">
                        ...
                        <fieldset>
                            ...
                            <input type="number" id="amount" name="amount" value={this.state.amount}
                            onChange={this.state.handleTextChange}/>
                            <label for="month">Month:</label>
                            <select id="month" name="month" value={this.state.month}
                            ...
                            <select id="year" name="year" value={this.state.year} onChange={this.handleSelectChange}>
                                ...
                                <option value="2017" id="17">2016</option>
                                <option value="2018" id="18">2016</option>
                                <option value="2019" id="19">2016</option>
                                <option value="2020" id="20">2016</option>
                            </select>
                        </fieldset>
